...
def get_config(config_name: str) -> ml_collections.ConfigDict:
  ...
  config.experiment_dir = '/opt/deepvariant/src/architecture_change/experiment/results/inception-random/'
  config.log_file = '/opt/deepvariant/src/architecture_change/experiment/results/inception-random/logs.log'
