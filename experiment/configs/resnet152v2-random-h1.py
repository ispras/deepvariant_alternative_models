...
def get_config(config_name: str) -> ml_collections.ConfigDict:
  ...
  config.experiment_dir = '/opt/deepvariant/src/architecture_change/experiment/results/resnet152v2-random-h1/'
  config.log_file = '/opt/deepvariant/src/architecture_change/experiment/results/resnet152v2-random-h1/logs.log'
