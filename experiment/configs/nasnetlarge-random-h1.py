...
def get_config(config_name: str) -> ml_collections.ConfigDict:
  ...
  config.experiment_dir = '/opt/deepvariant/src/architecture_change/experiment/results/nasnetlarge-random-h1/'
  config.log_file = '/opt/deepvariant/src/architecture_change/experiment/results/nasnetlarge-random-h1/logs.log'
